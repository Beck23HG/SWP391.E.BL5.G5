...
<html lang="en">
    ...
    <head>
        ...
        <style>
            ...
            .service-form {
                width: 100%;
                max-width: 750px; /* Chiều rộng tối đa gọn hơn */
                margin: 0 auto; /* Căn giữa form */
                padding: 1.5rem; /* Giảm padding */
                border: 1px solid #ddd; /* Viền nhẹ */
                border-radius: 8px; /* Bo góc */
                background-color: #ffffff; /* Nền trắng */
                box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); /* Shadow nhẹ */
            }

            /* Form group */
            .form-group {
                margin-bottom: 1.2rem; /* Khoảng cách giữa các nhóm nhỏ hơn */
            }
            ...
            .form-group label {
                ...
                font-weight: 600;
                margin-bottom: 0.3rem; /* Khoảng cách nhỏ hơn */
                color: #444; /* Màu chữ tối hơn nhẹ */
            }
            ...
            .service-form select {
                width: 100%;
                padding: 0.7rem; /* Giảm padding để nhỏ gọn */
                font-size: 0.9rem; /* Giảm kích thước font */
            ...
            .service-form select:focus {
                border-color: #007bff;
                outline: none;
                box-shadow: 0 0 4px rgba(0, 123, 255, 0.3); /* Shadow nhẹ */
            }

            /* Textarea styling */
            .service-form textarea {
                resize: vertical;
                min-height: 100px; /* Chiều cao tối thiểu nhỏ hơn */
            }
        ...
        <div class="main-content">
            ...
            <div class="page-header">
                ...
                <div>
                    ...
                    <div>
                        <div>
                            <h2 style="text-align: center; margin-bottom: 2%">Edit Service</h2>
                        </div>
                        <div>
                            <form action="updateImage" method="post" class="service-form" id="uploadForm">
                            ...
                            <form action="editService" method="post" class="service-form" onsubmit="showAlert();">
                                <input type="hidden" name="id" value="${service.serviceId}">
                                ...
                                <div class="form-row">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="price" min="0" step="10" value="${service.price}" required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="detail" rows="6" required>${service.detail}</textarea>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group">
                                        ...
                                        <select id="serviceStatus" name="status" required>
                                            <option value="1" ${service.status eq "1" ? "selected" : ""}>Active</option>
                                            <option value="0" ${service.status eq "0" ? "selected" : ""}>Inactive</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="action-btn edit" data-action="save"><i class="fas fa-edit"></i>Edit</button>
                                </div>
                            </form>
                        </div>
