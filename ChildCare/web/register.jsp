        ...
        <body class="auth-page">
                                ...
                                <form action="register" method="post" id="registerForm" class="auth-form" onsubmit="showAlert();">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group auth-input">
                                            ...
                                            <input type="tel" name="fullName" class="form-control" id="fullName" placeholder="Enter full name" required>
                                        </div>
                                    </div>
            ...
            <script>
                document.getElementById('registerForm').addEventListener('submit', function(event) {
                    ...
                    // Update the values back to the form fields
