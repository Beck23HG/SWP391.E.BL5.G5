...
<body>
    ...
    <main id="main-content">
        ...
        <section class="success-hero">
            <div class="container">
                ...
                <p class="text-center">Reservation ID: <span class="fw-bold" id="reservationId">RES-2024-001</span></p>
            </div>
        </section>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="content-card mb-4">
                            ...
                            <div class="payment-info mt-4">
                                ...
                                <div class="bank-accounts mt-4">
                                    ...
                                    <div class="bank-account-list" id="bankAccounts">
                        ...
                        <div class="content-card">
                            <h2>Next Steps</h2>
                            <div class="steps-info mt-4">
                                <div class="step-list">
                                    <div class="step-item">
                                        <div class="step-number">1</div>
                                        <div class="step-content">
                                            <h5>Complete Payment</h5>
                                            <p>Transfer the payment using the provided bank details</p>
                                        </div>
                                    </div>
                                    <div class="step-item">
                                        ...
                                        <div class="step-content">
                                            ...
                                            <p>Send your payment receipt via email</p>
                                        </div>
                                    </div>
                                    <div class="step-item">
                                        ...
                                        <div class="step-content">
                                            ...
                                            <p>Receive final confirmation and appointment details</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script src="assets/js/reservation-success.js"></script>
</body>
